                  ...
                  validator: (p0) {
                    ...
                    onTap: ()
                    {
                      if (_formKey.currentState!.validate()) {
                        _appointmentDetails.addAppointmentDetails(AppointmentDb(patientName: nameController.text, mobileNumber: mobileController.text, city: cityController.text, date: dateController.text, time: timeController.text));
