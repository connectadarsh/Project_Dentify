...
import 'package:dentify/view/CaseHistory/case_history.dart';
        ...
        Column(
          children: [
            Container(
              ...
              child: InkWell(
                child: Image.asset('asset/Appt1.png'),
                onTap: () {
                  Navigator.push(
                      context,
                      MaterialPageRoute(
        ...
        Column(
          children: [
            Container(
              ...
              width: 50,
              child: InkWell(
                child: Image.asset('asset/crownImage4.png'),
                onTap: () {
                  Navigator.push(
                      context,
                      MaterialPageRoute(
                        builder: (context) => Maincrowns(),
                      ));
                },
              ),
            ),
