...
class _ListappointmentState extends State<Listappointment> {
  ...
  List<AppointmentDb> filteredAppointments = [];
String searchQuery='';
  @override
    ...
    return Scaffold(
      ...
      body: ValueListenableBuilder(
        ...
        builder: (context, Box<AppointmentDb> box, child) {
          var allAppointments= box.values.toList().cast<AppointmentDb>();
          // search filter

         filteredAppointments = searchQuery.isEmpty?
         allAppointments:
         allAppointments.where((value){
          final nameLower=value.patientName.toLowerCase();
          final mobileLower=value.mobileNumber.toLowerCase();
          final queryLower=searchQuery.toLowerCase();
          return nameLower.contains(queryLower)|| mobileLower.contains(queryLower);
         }).toList();
          ...
          if (allAppointments.isEmpty) {
            ...
            return ListView.builder(
              ...
              itemBuilder: (context, index) {
                final patientAppointment = filteredAppointments[index];
                return Padding(
                  padding:
